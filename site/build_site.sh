...
emcc -I ./inc/ src/*.cpp site/emscripten_lib.cpp -o site/out/sci.html -sEXPORTED_FUNCTIONS=_SolveFormulas -sEXPORTED_RUNTIME_METHODS=ccall,cwrap --shell-file site/html_template/shell_minimal.html
