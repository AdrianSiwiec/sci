    ...
    \begin{itemize}
        ...
        \item $
                  \tilde{\lnot}'a = \begin{cases}
                      \tilde{\lnot}a , & \text{if } a = v(\psi) \text{ and } \lnot \psi \in \SUB(\varphi) \\
                      0,               & \text{otherwise, if } a \in D' \cup \{1\},            \\
                      1,               & \text{otherwise,}                                                \\
                  \end{cases}
              $
        \item $
                  a\tilde{\ra}'b = \begin{cases}
                      a\tilde{\ra}b , & \text{if } a = v(\psi), b = v(\vartheta) \text{ and } \psi \ra \vartheta \in \SUB(\varphi) \\
